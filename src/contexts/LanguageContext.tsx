...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'registrationSteps': 'Schritt für Schritt zur Online-Anmeldung',
    'step1': 'Fülle die Formularfelder unten aus und sende es ab',
    'step2': 'Du bekommst eine E-Mail mit unseren Kontodaten',
    'step3': 'Überweise den Anmeldegrundbetrag auf unser Konto',
    'step4': 'Sobald der Anmeldegrundbetrag auf unserem Konto eingegangen ist, bekommst Du eine E-Mail von uns',
    'step5': 'Ab jetzt bist Du bei uns registriert und kannst somit mit der Ausbildung beginnen',
    'step6': 'Antrag (Erhältst Du in der Fahrschule), Sehtest, Erste-Hilfe Bescheinigung und 2 Passbilder bei der zuständigen Behörde abgeben',
    'dataPrivacyNote': 'Deine Daten werden bei uns sicher gespeichert und wir verwenden diese Daten auch nur für Deine Ausbildung.',
    ...
    'registrationType': 'Anmeldeart',
    'firstTime': 'Ersterteilung',
    'extension': 'Erweiterung',
    'conversion': 'Umschreibung',
    'schoolChange': 'Fahrschulwechsel',
    'upgrade': 'Aufsteiger',
    'refresher': 'Auffrischungsfahrten',
    'commentsFeld': 'Bemerkungen',
    'gdprConsent': 'DSGVO Zustimmung',
    'gdprText': 'Ich habe die Datenschutzerklärung zur Kenntnis genommen. Ich erteile meine jederzeit widerrufliche Einwilligung, per E-Mail sowie telefonisch ein Angebot zu den Dienstleistungen zu erhalten.',
    'gdprRequired': 'Sie müssen der Datenschutzerklärung zustimmen',
    'submitRegistration': 'Anmeldung absenden',
    'registrationSuccess': 'Anmeldung erfolgreich',
    'registrationSuccessMessage': 'Vielen Dank für Ihre Anmeldung! Sie erhalten in Kürze eine E-Mail mit weiteren Informationen.',
    ...
    'totalLessonsGiven': 'Gegebene Fahrstunden',
    ...
    'classReports': 'Stundenberichte',
    'classesCompleted': 'Abgeschlossene Stunden',
    'classesTaught': 'Gehaltene Stunden',
    'exportPdf': 'Als PDF exportieren',
    'theory': 'Theorie',
    'practical': 'Praxis',
    'total': 'Gesamt',
    'studentName': 'Schüler',
    'teacherName': 'Fahrlehrer',
    'classesCompletedByStudent': 'Abgeschlossene Stunden pro Schüler (monatlich)',
    'classesTaughtByTeacher': 'Gehaltene Stunden pro Fahrlehrer (monatlich)',
    'reportGenerated': 'Bericht erstellt',
    'fromMonth': 'Von Monat',
    'toMonth': 'Bis Monat',
    'exportFullReport': 'Gesamtbericht als PDF',
    ...
    // Tutorial
    'tutorialPromptTitle': 'Kurze Einführung anzeigen?',
    'tutorialPromptDescription': 'Möchten Sie eine kurze Tour durch die wichtigsten Bereiche sehen? Sie können jederzeit überspringen.',
    'tutorialShowTour': 'Tour starten',
    'tutorialNoThanks': 'Nein, danke',
    'tutorialNext': 'Weiter',
    'tutorialFinish': 'Fertig',
    'tutorialStepLabel': 'Tutorial-Schritt',
    'tutorialWelcomeTitle': 'Willkommen in der Fahrschul-Verwaltung',
    'tutorialWelcomeDescription': 'Diese Tour führt Sie in wenigen Schritten durch die Oberfläche. Sie sehen nacheinander: wo Sie sich befinden, die Navigation, das Dashboard, Nachrichten, Sprache und Abmeldung. Mit „Weiter“ geht es vorwärts, mit „Zurück“ zurück. Sie können die Tour jederzeit mit dem X schließen.',
    'tutorialHeaderBrandTitle': 'App-Name und Ihr Konto',
    'tutorialHeaderBrandDescription': 'Hier stehen der Name der Anwendung (ByteTechnik Fahrschule) und darunter Ihr Name sowie Ihre Rolle (Administrator, Fahrlehrer oder Schüler). So sehen Sie immer, mit welchem Konto Sie angemeldet sind. Auf kleinen Bildschirmen öffnet das Menü-Symbol links die Navigation.',
    'tutorialSidebarTitle': 'Seitennavigation',
    'tutorialSidebarDescription': 'In der linken Leiste wechseln Sie zwischen den Bereichen: Dashboard für die Übersicht, Schüler und ggf. Fahrlehrer für die Verwaltung, Theoriestunden und praktische Fahrstunden, Kalender und Termine, Zahlungen, Shop, Stundenberichte und Nachrichten. Der aktuell gewählte Bereich ist hervorgehoben.',
    'tutorialDashboardStatsTitle': 'Übersichtskarten auf dem Dashboard',
    'tutorialDashboardStatsDescription': 'Diese Karten zeigen die wichtigsten Kennzahlen auf einen Blick – z. B. Anzahl Schüler, Fahrlehrer, aktive Konten oder Theoriestunden. Je nach Rolle können hier auch Termine, Fortschritt oder Bewertungen erscheinen. Weiter unten finden Sie Diagramme, aktuelle Aktivitäten und Schnellzugriffe.',
    'tutorialMessagesTitle': 'Nachrichten',
    'tutorialMessagesDescription': 'Über das Glockensymbol öffnen Sie Ihre Nachrichten. Eine rote Markierung mit Zahl zeigt an, wie viele Nachrichten ungelesen sind. So verpassen Sie keine wichtigen Hinweise von der Verwaltung oder Ihrem Fahrlehrer.',
    'tutorialLanguageTitle': 'Sprache umschalten',
    'tutorialLanguageDescription': 'Hier können Sie die Oberfläche zwischen Deutsch und Englisch umschalten. Die Auswahl gilt sofort für alle Bereiche der Anwendung.',
    'tutorialLogoutTitle': 'Abmelden',
    'tutorialLogoutDescription': 'Mit diesem Button melden Sie sich sicher vom System ab. Danach werden Sie zur Anmeldeseite weitergeleitet. Bitte melden Sie sich immer ab, wenn Sie an einem gemeinsamen Gerät arbeiten.',
    'tutorialMainTitle': 'Hauptbereich und Seiteninhalt',
    'tutorialMainDescription': 'In diesem großen Bereich wird der Inhalt der gewählten Seite angezeigt: z. B. das Dashboard mit Kennzahlen und Übersichten, Listen von Schülern oder Fahrlehrern, Kalender, Zahlungen oder Nachrichten. Je nach gewähltem Menüpunkt ändert sich der Inhalt hier.',
    'tutorialCompleteTitle': 'Tour beendet',
    'tutorialCompleteDescription': 'Sie haben die wichtigsten Bereiche kennengelernt. Bei Fragen wenden Sie sich an Ihre Fahrschule. Sie können sich jederzeit erneut anmelden und die Tour nach dem Login erneut starten, wenn Sie die Einführung wiederholen möchten. Viel Erfolg!',
  },
  en: {
    // Auth
    'login': 'Login',
    ...
    'registrationSteps': 'Step by Step Online Registration',
    'step1': 'Fill out the form fields below and submit',
    'step2': 'You will receive an email with our bank details',
    'step3': 'Transfer the registration base amount to our account',
    'step4': 'Once the registration base amount is received, you will receive an email from us',
    'step5': 'From now on you are registered with us and can start your training',
    'step6': 'Submit application (you will receive it at the driving school), eye test, first aid certificate and 2 passport photos to the relevant authority',
    'dataPrivacyNote': 'Your data is securely stored with us and we only use this data for your training.',
    ...
    'commentsFeld': 'Comments',
    'gdprConsent': 'GDPR Consent',
    'gdprText': 'I have read the privacy policy. I give my consent, which can be revoked at any time, to receive an offer of services by email and telephone.',
    'gdprRequired': 'You must agree to the privacy policy',
    'submitRegistration': 'Submit Registration',
    'registrationSuccess': 'Registration Successful',
    'registrationSuccessMessage': 'Thank you for your registration! You will receive an email with further information shortly.',
    ...
    'passRate': 'Pass Rate',
    'totalLessonsGiven': 'Total Lessons Given',
    ...
    'studentName': 'Student',
    'teacherName': 'Teacher',
    'classesCompletedByStudent': 'Classes completed per student (monthly)',
    'classesTaughtByTeacher': 'Classes taught per teacher (monthly)',
    'reportGenerated': 'Report generated',
    'fromMonth': 'From month',
    'toMonth': 'To month',
    'exportFullReport': 'Export full report (PDF)',
    ...
    // Tutorial
    'tutorialPromptTitle': 'Show quick tour?',
    'tutorialPromptDescription': 'Would you like a short tour of the main areas? You can skip at any time.',
    'tutorialShowTour': 'Start tour',
    'tutorialNoThanks': 'No thanks',
    'tutorialNext': 'Next',
    'tutorialFinish': 'Finish',
    'tutorialStepLabel': 'Tutorial step',
    'tutorialWelcomeTitle': 'Welcome to the driving school management',
    'tutorialWelcomeDescription': 'This tour walks you through the interface in a few steps. You will see: where you are in the app, the main navigation, the dashboard, messages, language settings, and logout. Use „Next“ to advance and „Back“ to go back. You can close the tour at any time with the X button.',
    'tutorialHeaderBrandTitle': 'App name and your account',
    'tutorialHeaderBrandDescription': 'This shows the application name (ByteTechnik Fahrschule) and below it your name and role (Administrator, Teacher, or Student). You can always see which account you are signed in with. On small screens, the menu icon on the left opens the navigation.',
    'tutorialSidebarTitle': 'Page navigation',
    'tutorialSidebarDescription': 'Use the left sidebar to switch between sections: Dashboard for the overview, Students and Teachers for management, Theory and practical lessons, Calendar and appointments, Payments, Shop, Class reports, and Messages. The current section is highlighted.',
    'tutorialDashboardStatsTitle': 'Dashboard overview cards',
    'tutorialDashboardStatsDescription': 'These cards show the main figures at a glance – e.g. number of students, teachers, active accounts, or theory lessons. Depending on your role, you may also see appointments, progress, or ratings. Below you will find charts, recent activity, and quick links.',
    'tutorialMessagesTitle': 'Messages',
    'tutorialMessagesDescription': 'The bell icon opens your messages. A red badge with a number indicates how many messages are unread, so you do not miss important updates from the office or your instructor.',
    'tutorialLanguageTitle': 'Change language',
    'tutorialLanguageDescription': 'Here you can switch the interface between German and English. The change applies immediately across the whole application.',
    'tutorialLogoutTitle': 'Log out',
    'tutorialLogoutDescription': 'Use this button to sign out securely. You will then be taken to the login page. Please always log out when using a shared device.',
    'tutorialMainTitle': 'Main area and page content',
    'tutorialMainDescription': 'This is where the content of the selected page is shown: e.g. the dashboard with stats and overviews, lists of students or teachers, calendar, payments, or messages. The content here changes according to the menu item you choose.',
    'tutorialCompleteTitle': 'Tour complete',
    'tutorialCompleteDescription': 'You have seen the main parts of the application. If you have questions, contact your driving school. You can log in again later and start the tour again after login if you want to repeat the introduction. Good luck!',
  }
};
