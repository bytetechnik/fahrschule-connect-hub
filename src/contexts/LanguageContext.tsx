...
const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    'appointmentCreated': 'Appointment created successfully',
    'appointmentUpdated': 'Appointment updated successfully',
    'appointmentCancelled': 'Appointment cancelled. Tickets have been returned to the student.',
    'appointmentDeleted': 'Appointment deleted. Tickets have been returned to the student.',
    'appointmentCompleted': 'Appointment marked as completed',
    'editAppointment': 'Edit Appointment',
    'updateAppointmentDetails': 'Update appointment details. Ticket count will be automatically adjusted.',
    'cancelAppointment': 'Cancel Appointment',
    'cancelAppointmentDescription': 'Cancel appointment. Tickets will be returned to the student. Cancellation reason is required.',
    'cancelReason': 'Cancellation Reason',
    'cancelReasonRequired': 'Cancellation reason *',
    'cancelReasonPlaceholder': 'Enter reason for cancellation...',
    'markAsCompleted': 'Approve / Mark as Completed',
    'cannotUndoApproval': 'You cannot undo this action',
    'confirmCompletion': 'Mark appointment as completed? You cannot undo this action. Only an administrator can undo this.',
    'about': 'About',
    'courses': 'Courses',
    'theDrivingSchool': 'The Driving School',
    'ourStory': 'Our Story',
