    ...
    <Layout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">View payments from your students</p>
        </div>
