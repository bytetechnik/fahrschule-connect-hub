...
import { CheckCircle, ArrowLeft, Video, FileText } from 'lucide-react';
import { getLessons, getProgress, saveProgress } from '@/lib/mockData';
...
const LessonDetail = () => {
  ...
  const isCompleted = progress.some(
    p => p.studentId === user?.id && p.lessonId === lesson.id && p.completed
  );
